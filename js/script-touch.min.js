...
*/
window.log=function(){log.history=log.history||[],log.history.push(arguments),this.console&&console.log(Array.prototype.slice.call(arguments))},function(doc){var write=doc.write;doc.write=function(q){log("document.write():",arguments),/docwriteregexwhitelist/.test(q)&&write.apply(doc,arguments)}}(document),/*! 
...
*/
$(function(){getWidth(),$(window).resize(getWidth),loadSearch(),activateMenus()}),/*! 
...
*/
$(function(){var body=$("body"),width=$(window).width(),swipewidth=Math.floor(.16*width);swipewidth>150&&(swipewidth=150),50>swipewidth&&(swipewidth=50),$("#main-header, #search-menu, #content, #page-footer, .nav-container").swipe({swipeLeft:function(event,direction){var slider=checkSliderSwipe(event.target,direction);!slider&&body.hasClass("sideNav")&&body.toggleClass("sideNav")},swipeRight:function(event,direction){var slider=checkSliderSwipe(event.target,direction);slider||body.hasClass("sideNav")||body.toggleClass("sideNav")},triggerOnTouchEnd:!1,threshold:swipewidth})});