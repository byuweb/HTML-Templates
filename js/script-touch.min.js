...
*/
var byu_template=function($){"use strict";function activateMenus(){$("#search-menu").delegate(".menu-button","click",function(e){e.stopPropagation(),e.preventDefault(),$("body").toggleClass("sideNav")}),$("nav li:has(.mega, .sub) > a").click(function(e){e.preventDefault();var li=$(this).parent();return li.hasClass("hover")&&clickOpened?li.removeClass("hover"):(li.addClass("hover"),$("nav li").not(li).removeClass("hover"),clickOpened=!0),!1}),$("nav li:has(.mega, .sub)").click(function(e){e.stopPropagation()}),$("nav li .sub").each(function(){var mega=$(this),left=mega.parent().position().left;left>mega.parent().parent().outerWidth()-mega.outerWidth()&&mega.css("right",0)}),$(window).resize(function(){$(window).width()>768?$("body").removeClass("sideNav"):$(window).width()<768&&$(".hover")[0]&&$("body").addClass("sideNav")}),$("body").click(function(){$(".hover").removeClass("hover")}),$("#content").click(function(){$("body").removeClass("sideNav")})}function loadSearch(){window.__gcse={callback:function(){"complete"==document.readyState&&$("#basic-search").hide()}},function(){var cx="009932716493032633443:hlqjz33kfkc",gcse=document.createElement("script");gcse.type="text/javascript",gcse.async=!0,gcse.src=("https:"==document.location.protocol?"https:":"http:")+"//www.google.com/cse/cse.js?cx="+cx;var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(gcse,s)}()}var clickOpened=!1;$(function(){$(window).width(),executeAfterBreakpoint([activateMenus,loadSearch],256)})}(jQuery);/*! 
