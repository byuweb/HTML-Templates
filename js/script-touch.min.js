...
*/
$(function(){var body=$("body");$("#main-header, #search-menu, #content, #page-footer, .nav-container").swipe({swipeLeft:function(){body.hasClass("sideNav")&&body.toggleClass("sideNav")},swipeRight:function(){body.hasClass("sideNav")||body.toggleClass("sideNav")},threshold:50})});