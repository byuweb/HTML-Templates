...
*/
$(function(){var body=$("body"),width=$(window).width(),swipewidth=Math.floor(.16*width);swipewidth>150&&(swipewidth=150),50>swipewidth&&(swipewidth=50),$("#main-header, #search-menu, #content, #page-footer, .nav-container").swipe({swipeLeft:function(){body.hasClass("sideNav")&&body.toggleClass("sideNav")},swipeRight:function(){body.hasClass("sideNav")||body.toggleClass("sideNav")},triggerOnTouchEnd:!1,threshold:swipewidth}),"function"==typeof $.anythingSlider&&$("#slider").anythingSlider({onInitialized:function(e,slider){setupSwipe(slider)}})});var setupSwipe=function(slider){var time=1e3,range=50,x=0,t=0,touch="ontouchend"in document,st=touch?"touchstart":"mousedown",mv=touch?"touchmove":"mousemove",en=touch?"touchend":"mouseup";slider.$window.bind(st,function(e){e.preventDefault(),t=(new Date).getTime(),x=e.originalEvent.touches?e.originalEvent.touches[0].pageX:e.pageX}).bind(en,function(){t=0,x=0}).bind(mv,function(e){e.preventDefault();var newx=e.originalEvent.touches?e.originalEvent.touches[0].pageX:e.pageX,r=0===x?0:Math.abs(newx-x),ct=(new Date).getTime();0!==t&&time>ct-t&&r>range&&(x>newx&&slider.goForward(),newx>x&&slider.goBack(),t=0,x=0)})};