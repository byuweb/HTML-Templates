/* Compiled from https://github.com/typekit/webfontloader on June 21, 2013 */
(function(window, document, undefined) {
    ...
    function ra(a) {
        ...
        b === a.F.serif && c === a.F["sans-serif"] || a.k.T && sa(a, b, c) ? ea() - a.ya >= a.S ? a.k.T && sa(a, b, c) && (a.Z === l || a.Z.hasOwnProperty(a.q.getName())) ? Q(a, a.V) : Q(a, a.ta) : setTimeout(s(function() {
            ra(this);
        }, a), 25) : Q(a, a.V);
    }
    function Q(a, b) {
        ...
        c ? (e.__webfonttypekitmodule__ || (e.__webfonttypekitmodule__ = {}), e.__webfonttypekitmodule__[c] = function(c) {
            c(a, d, function(a, c, d) {
                for (var e = 0; e < c.length; e += 1) {
                    var g = d[c[e]];
                    if (g) for (var P = 0; P < g.length; P += 1) f.m.push(new H(c[e], g[P])); else f.m.push(new H(c[e]));
                }
                b(a);
            });
