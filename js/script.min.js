...
function activateMenus() {
    $("#search-menu").delegate(".menu-button", "click", function (e) {
        e.stopPropagation(), e.preventDefault(), $("body").toggleClass("sideNav")
        ...
        e.stopPropagation()
    }), $("nav.no-js").removeClass("no-js"), $("nav li .sub").each(function () {
        var mega = $(this),
...
*/
$(function () {
    getWidth(), $(window).resize(getWidth), loadSearch(), activateMenus()
});