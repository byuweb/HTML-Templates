 ...
 * Build: http://modernizr.com/download/#-fontface-generatedcontent-svg-touch-printshiv-mq-cssclasses-teststyles-prefixes-load
 */
window.Modernizr = function(a, b, c) {
    ...
    var d = "2.6.2", e = {}, f = !0, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, k, l = ":)", m = {}.toString, n = " -webkit- -moz- -o- -ms- ".split(" "), o = {
        svg: "http://www.w3.org/2000/svg"
    }, p = {}, q = {}, r = {}, s = [], t = s.slice, u, v = function(a, c, d, e) {
    ...
    !B(x, "undefined") && !B(x.call, "undefined") ? y = function(a, b) {
        ...
        var a;
        return v([ "#", h, "{font:0/0 a}#", h, ':after{content:"', l, '";visibility:hidden;font:3px/1 a}' ].join(""), function(b) {
            a = b.offsetHeight >= 3;
        }), a;
    }, p.svg = function() {
        return !!b.createElementNS && !!b.createElementNS(o.svg, "svg").createSVGRect;
    };
    for (var E in p) y(p, E) && (u = E.toLowerCase(), e[u] = p[E](), s.push((e[u] ? "" : "no-") + u));
    return e.addTest = function(a, b) {
        ...
        return e;
    }, z(""), i = k = null, e._version = d, e._prefixes = n, e.mq = w, e.testStyles = v, 
