...
<i>To download the templates, go to the <a href="/byuweb/HTML-Templates/releases">release page</a></u>.<br> 

<i>For developers who want to use SCSS, Jade, and Grunt to compile pages, <a href="/byuweb/HTML-Templates/blob/gh-pages/README-developers.md">see a more detailed documentation page</a> on the Wiki.</i><br>
